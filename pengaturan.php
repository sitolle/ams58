        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['alamat1'] == "" || $_REQUEST['alamat2'] == "" || $_REQUEST['kepsek'] == "" || $_REQUEST['nip'] == ""
                        ...
                        if(!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $institusi)){
                                $_SESSION['institusi'] = 'Form Nama Yayasan hanya boleh mengandung karakter huruf, angka, spasi, titik(.), minus(-) dan garis miring (/)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {

                                if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat1)){
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',alamat1='$alamat1',alamat2='$alamat2',kepsek='$kepsek',nip='$nip',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',alamat1='$alamat1',alamat2='$alamat2',kepsek='$kepsek',nip='$nip',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="institusi" type="text" class="validate" name="institusi" value="<?php echo $row['institusi']; ?>" required>
                                            ...
                                            ?>
                                        <label for="institusi">Nama Kementerian/Lembaga</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <i class="material-icons prefix md-prefix">assistant_photo</i>
                                        <input id="alamat1" type="text" class="validate" name="alamat1" value='<?php echo $row['alamat1']; ?>' required>
                                            <?php
                                                if(isset($_SESSION['alamat1'])){
                                                    $alamat1 = $_SESSION['alamat1'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$alamat1.'</div>';
                                                    unset($_SESSION['alamat1']);
                                                }
                                            ?>
                                        <label for="status">Alamat 1</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="alamat2" type="text" class="validate" name="alamat2" value="<?php echo $row['alamat2']; ?>" required>
                                            <?php
                                    ...
                                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Jika tidak ada logo, biarkan kosong">
                                        <div class="file-field input-field">
                                            ...
                                            <div class="file-path-wrapper">
                                                ...
                                                ?>
                                            <small class="red-text">*Format file yang diperbolehkan hanya *.JPG, *.PNG dan ukuran maksimal file 100 MB. Disarankan gambar berbentuk kotak atau lingkaran!</small>
                                        </div>
                                    </div>
                                    <div class="input-field col s6">
