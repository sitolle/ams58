    ...
    <div class="footer-copyright blue-grey darken-1 white-text">
        <div class="container" id="footer">
            ...
            <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        echo $data['nama']/* .' &nbsp;|&nbsp; <a class="white-text" href="http://curious-kkpi.blogspot.com" target="_blank">By M. Rudianto, Modified by Indra Sulyana</a>'*/;
                    } else {
            ...
            <div class="right hide-on-small-only">
                <?php
                    if(!empty($data['website'])){
                        ...
                        echo '<i class="material-icons md-12">public</i> www.atrbpn.go.id &nbsp;&nbsp;';
                    }
                    if(!empty($data['email'])){
                        echo '<i class="material-icons">mail_outline</i> '.$data['email'].'';
                    } else {
                        echo '<i class="material-icons">mail_outline</i>  irjend.atr@gmail.com';
                    }
                }
                ?>
            </div>
